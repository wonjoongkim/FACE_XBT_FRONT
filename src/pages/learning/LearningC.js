...
import { Modal, Spin, Image, Skeleton } from 'antd';
...
export const LearningC = (props) => {
    ...
    const [cut_time, setCut_time] = useState(8000);
        ...
        $('.learnbtc04 button').click(async function () {
            if ($(this)[0].id == 'learn02_Open') {
                ...
                if ($(this)[0].id == 'learn02_Pass') {
                    ...
                    UpdateLearnAnswer_ApiCall('1', $(images[currentImageIndex]).data('value')); // 미개봉/금지 Prohibited [1]
                } else if ($(this)[0].id == 'learn02_Open_Pass') {
                    UpdateLearnAnswer_ApiCall('3', $(images[currentImageIndex]).data('value')); // 개봉/제한 Open/Pass [3]
                } else if ($(this)[0].id == 'learn02_Open_Resricted') {
                    UpdateLearnAnswer_ApiCall('2', $(images[currentImageIndex]).data('value')); // 개봉/통과 Open/Resricted [2]
                ...
                <div className="learn_con">
                    ...
                    <div className="xbt_top">
                        ...
                        <div className="learnct01">
                            <ul>
                                <li>
                                    <h1 className="contit">{languageApplyInfoData.learning1}(Cut)</h1>
                                </li>
                                <li>
