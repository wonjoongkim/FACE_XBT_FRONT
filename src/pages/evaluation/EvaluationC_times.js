        ...
        $('.learnbtc04 button').click(async function () {
            if ($(this)[0].id == 'learn02_open') {
                ...
                if ($(this)[0].id == 'learn02_pass') {
                    ...
                    UpdateEvaluationAnswer_ApiCall('1', $(images[currentImageIndex]).data('value')); // 미개봉/금지 Pass [1]
                } else if ($(this)[0].id == 'learn02_Open_Pass') {
                    UpdateEvaluationAnswer_ApiCall('3', $(images[currentImageIndex]).data('value')); // 개봉/제한 Open/Resricted [2]
                } else if ($(this)[0].id == 'learn02_Open_Resricted') {
                    UpdateEvaluationAnswer_ApiCall('2', $(images[currentImageIndex]).data('value')); // 개봉/통과 Open/Pass [3]
