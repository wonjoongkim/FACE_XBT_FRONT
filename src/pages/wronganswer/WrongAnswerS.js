        ...
        $('.learnbtc04 button').click(async function () {
            if ($(this)[0].id == 'learn01_Open') {
                ...
                if ($(this)[0].id == 'learn01_Pass') {
                    UpdateWrongAnswer_ApiCall('4', bag_id[current_image]); // 미개봉/통과 pass [4]
                } else if ($(this)[0].id == 'learn01_Prohibited') {
                    UpdateWrongAnswer_ApiCall('1', bag_id[current_image]); // 미개봉/금지 Prohibited [1]
                } else if ($(this)[0].id == 'learn01_Open_Pass') {
                    UpdateWrongAnswer_ApiCall('3', bag_id[current_image]); // 개봉/제한 Open/Pass [3]
                } else if ($(this)[0].id == 'learn01_Open_Resricted') {
                    UpdateWrongAnswer_ApiCall('2', bag_id[current_image]); // 개봉/통과 Open/Resricted [2]
                } else if ($(this)[0].id == 'learn01_Open_Prohibited') {
                    UpdateWrongAnswer_ApiCall('0', bag_id[current_image]); // 개봉/금지 Open/Prohibited [0]
                }
                learn01_btn();
                setAnswerType(null);
            }
                ...
                <div className="learn_con">
                    <div className="xbt_top">
                        <div className="learnct01">
                            <ul>
                                <li>
                                    <h1 className="contit">{languageApplyInfoData.oxplay1}(Slide)</h1>
                                </li>
                                <li>
