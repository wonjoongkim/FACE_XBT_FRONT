...
export const WrongAnswerP = (props) => {
    ...
    // 오답문제풀이완료 정답확인 Api
    const [WrongAnswerCompleteApi] = useSelectWrongAnswerCompleteMutation();
    const [wrongAnswerCompleteData, setWrongAnswerCompleteData] = useState([]);
    ...
    const LearningComplete_ApiCall = async () => {
        const WrongAnswerCompleteResponse = await WrongAnswerCompleteApi({
            menuCd: props.MenuCd,
            languageCode: localStorage.getItem('LangTp')
        });
        // console.log(props.MenuCd);
        setWrongAnswerCompleteData(WrongAnswerCompleteResponse?.data?.RET_DATA);
        setLoading(false);
    };
            ...
            <div className="xbt_content">
                ...
                <div className="xbt_top" style={{ zIndex: '9999' }}>
                    ...
                    <div className="learnct01">
                        <ul>
                            <li>
                                <h1 className="contit">{languageApplyInfoData.oxplayend1}</h1>
                            </li>
                            <li>
                                <h3>{wrongAnswerCompleteData?.moduleNm}</h3>
                            </li>
                            <li>
                                <h2 className="conname">{wrongAnswerCompleteData?.userName}</h2>
                                <button
                                    id="close-th-modal"
                                    data-mact="close"
                                    data-minfo="th-modal"
                    ...
                    <div className="lrncomp_right">
                        ...
                        <div className="lrncompr_con01 conbox_sty conbox_pd01">
                                ...
                                <table className="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style={{ width: '21%' }}>{languageApplyInfoData.oxplayend4}</th>
                                            <th style={{ width: '21%' }}>{languageApplyInfoData.oxplayend5}</th>
                                            <th style={{ width: '21%' }}>{languageApplyInfoData.oxplayend6}</th>
                                            <th style={{ width: '21%' }}>{languageApplyInfoData.oxplayend7}</th>
                                        </tr>
                                    </thead>
                                </table>
                            </div>
                            ...
                            <div className="con_table height120 scrollbar">
                                <table className="table">
                                    <tbody>
                                        {wrongAnswerCompleteData?.learningProblemList?.map((t, i) => {
                                            return (
                                                <tr
                                                    className={choiceGoods === t.bagScanId ? 'on' : ''}
                                                    key={i}
                            ...
                            <div className="con_table">
                                <table className="table">
                                    ...
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th>{languageApplyInfoData.oxplayend8}</th>
                                            {/* <th>{languageApplyInfoData.oxplayend9}</th>
                                            <th>{languageApplyInfoData.oxplayend10}</th> */}
                                        </tr>
                                    </thead>
                                </table>
                            </div>
