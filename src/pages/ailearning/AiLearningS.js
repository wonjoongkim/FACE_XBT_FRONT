...
export const AiLearningS = (props) => {
    ...
    const EndAiLearning_ApiCall = async () => {
        const EndAiLearningResponse = await EndAiLearningApi({
            menuCd: props.MenuCd
        });
    ...
    //AI강화학습시작-슬라이더 타입의 시작 버튼 누르면 실행
    const learn01_start = () => {
        ...
        $('.learnbtc04 button').click(async function () {
            if ($(this)[0].id == 'learn01_open') {
                ...
                if ($(this)[0].id == 'learn01_pass') {
                    ...
                    UpdateLearnAnswer_ApiCall('1', bag_id[current_image]); // 미개봉/금지 Pass [1]
                } else if ($(this)[0].id == 'learn01_Open_Pass') {
                    UpdateLearnAnswer_ApiCall('3', bag_id[current_image]); // 개봉/제한 Open/Resricted [2]
                } else if ($(this)[0].id == 'learn01_Open_Resricted') {
                    UpdateLearnAnswer_ApiCall('2', bag_id[current_image]); // 개봉/통과 Open/Pass [3]
                ...
                <div className="learn_con">
                    <div className="xbt_top">
                        <div className="learnct01">
                            <ul>
                                <li>
                                    <h1 className="contit">Ai강화학습(Slide)</h1>
                                </li>
                                <li>
                                    <h3>
